...
import { Evented, LeafletMouseEvent } from 'leaflet';
...
export default function CreateOrphanage() {
  ...
  function hamdleSelectImages(event: ChangeEvent<HTMLInputElement>) {
        ...
        <form onSubmit={handleSubmit} className="create-orphanage-form">
          <fieldset>
            ...
            <div className="input-block">
              ...
              <input multiple onChange={hamdleSelectImages} type="file" id="image[]" />
